...
with the a-posteriori certificate $\gW\le\kappa_2(V_W)$, the eigenvector conditioning of $W$ that also governs the ReLU slack $\eta$ (\cref{rem:eta_relu}), so the two share this band) and report
